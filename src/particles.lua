...
function particles.createBoost()
    ...
    p:setSpeed(1000)
    p:setLinearAcceleration(0, 100)
    p:setSizes(1, 3, 1)
    p:setColors(255, 255, 255, 255) 
    p:setPosition(0, 0)
    p:setEmitterLifetime(0.5)
    p:setParticleLifetime(1.0)
...
function particles.createGib(x,y)
    ...
    p:setSpeed(0,1)
    p:setLinearAcceleration(500, 0)
    p:setSizes(0.5, 1)
    p:setColors(255, 0, 0, 255, 0, 0, 0, 0)
    p:setPosition(0, 0)
    p:setEmitterLifetime(2.0)
    p:setParticleLifetime(0.3,1.0)
    p:setDirection(12.25)
    p:setSpread(360)
    --p:setRotation(10, 5)
    p:setRadialAcceleration(0)
