...
function audio.load()
    ...
    audio.themusic = love.audio.newSource("data/audio/music.mp3")
    audio.intro_loop = love.audio.newSource("data/audio/intro_loop.mp3")
    level_up1 = love.audio.newSource("data/audio/level_up_1.mp3")
    level_up2 = love.audio.newSource("data/audio/level_up_2.mp3")
    audio.explosion = love.audio.newSource("data/audio/explosion.mp3")
